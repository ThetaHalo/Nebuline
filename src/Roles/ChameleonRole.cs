...
public class ChameloenRole : CrewmateRole, ICustomRole
{
    ...
    {
        Logger<NebulinePlugin>.Info("Initializing ChamelonRole for player: " + player.PlayerId);
    ...
    {
        Logger<NebulinePlugin>.Info("Deinitializing ChamelonRole for player: " + targetPlayer.PlayerId);
